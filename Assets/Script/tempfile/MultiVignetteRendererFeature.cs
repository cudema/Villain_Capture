...
public sealed class MultiVignetteRendererFeature : ScriptableRendererFeature
{
    ...
    public override void AddRenderPasses(ScriptableRenderer renderer, ref RenderingData renderingData)
    {
        ...
        MultiVignetteVolumeComponent myVolume = VolumeManager.instance.stack?.GetComponent<MultiVignetteVolumeComponent>();
    ...
    private class CustomPostRenderPass : ScriptableRenderPass
    {
        ...
        private static void ExecuteMainPass(RasterCommandBuffer cmd, RTHandle sourceTexture, Material material)
        {
            ...
            if (myVolume != null)
            {
                ...
                s_SharedPropertyBlock.SetVector("_1Center", myVolume.vignette1Center.value);
                s_SharedPropertyBlock.SetVector("_2Center", myVolume.vignette2Center.value);
                s_SharedPropertyBlock.SetFloat("_Vignette1Intensity", myVolume.vignette1Intensity.value);
